...
Set oApp = CreateObject("Excel.Application")
    ...
    oApp.Workbooks.Open ("C:\Desktop\Novo(a) Planilha do Microsoft Excel.xlsx") 'Aqui será aberto o arquivo Excel. Altere para o caminho que seu arquivo estiver alocado para abri-lo.
